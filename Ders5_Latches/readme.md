SystemVerilog eğitim serisinin 5. dersinde latch kavramı üzerinde durdum. if else ve case yapıları kullanıldığında hangi durumlarda latch oluşabileceğinden ve bunların çözümlerinden bahsettim. <br/>
